...
JNIEXPORT void JNICALL
Java_com_realxie_vulkandemo_MainActivity_initVulkanContextJNI(JNIEnv *env, jobject /*thiz*/, jobject surface)
{
...
JNIEXPORT void JNICALL
Java_com_realxie_vulkandemo_MainActivity_nativeRenderJNI(JNIEnv *env, jobject /*thiz*/, jfloat dt)
{
    if (RealRenderer::getInstance()->isReady())
    {
