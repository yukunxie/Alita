...
public:
    ...
    virtual void SetVertexBuffer(const Buffer* buffer, std::uint32_t offset = 0, std::uint32_t slot = 0) = 0;
    ...
    virtual void DrawIndexed(std::uint32_t indexCount, std::uint32_t instanceCount,
                             std::uint32_t firstIndex, std::uint32_t baseVertex, std::uint32_t firstInstance) = 0;
